...
public class TRepositoryInternalFrame extends MyInternalFrame implements ActionListener {
    ...
    public TRepositoryInternalFrame() {
        super("RDF Triple Repository", true, false, false, true);
        ...
        TitledBorder title;
        title = BorderFactory.createTitledBorder(blackline, "SPO input");
