...
/**
 * Grammar production: sparqlString -> SparqlString() nodeOptional -> (
 * <LANGTAG> | ( "^^" IRIref() ) )?
 */
@SuppressWarnings("serial")
public class RDFLiteral implements Node {

    public SparqlString sparqlString;
    public NodeOptional nodeOptional;

    public RDFLiteral(SparqlString n0, NodeOptional n1) {
        sparqlString = n0;
        nodeOptional = n1;
    }
