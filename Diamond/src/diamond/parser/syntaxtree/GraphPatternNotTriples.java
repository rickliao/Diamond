...
/**
 * Grammar production: nodeChoice -> OptionalGraphPattern() |
 * GroupOrUnionGraphPattern() | GraphGraphPattern() | Filter() | Bind()
 */
@SuppressWarnings("serial")
public class GraphPatternNotTriples implements Node {

    public NodeChoice nodeChoice;

    public GraphPatternNotTriples(NodeChoice n0) {
        nodeChoice = n0;
    }
