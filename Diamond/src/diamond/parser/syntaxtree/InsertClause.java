...
/**
 * Grammar production: nodeToken -> "{" nodeOptional -> ( InsertTriples() )?
 * nodeToken1 -> "}"
 */
@SuppressWarnings("serial")
public class InsertClause implements Node {

    public NodeToken nodeToken;
    public NodeOptional nodeOptional;
    public NodeToken nodeToken1;

    public InsertClause(NodeToken n0, NodeOptional n1, NodeToken n2) {
        nodeToken = n0;
        nodeOptional = n1;
        nodeToken1 = n2;
    }

    public InsertClause(NodeOptional n0) {
